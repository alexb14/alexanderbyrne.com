...
const Hypervenom = () => (
  <div>
    ...
    <Copy>
      As part of the release of their new Hyper Venom 3, Nike gave rebel
      customer’s a bold, powerful experience
    </Copy>

    <FullWidthMedia
      media="/images/hypervenom/desktop/hypervenom-scroll-3"
      width="1600"
      height="1000"
      video
    />
    ...
    <FullWidthMedia
      media="/images/hypervenom/other/player.jpg"
      width="3142"
      height="2095"
    />
    ...
    <FullWidthMedia
      media="/images/hypervenom/other/venom-shoe.jpg"
      width="2000"
      height="1333"
    />

    <MyRole roles={["Lead Interaction Designer"]} />
